          ...
          <div className="max-w-5xl mx-auto">
            ...
            {listings.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-sm mb-6" style={{ color: '#595959' }}>Browse all listings and use the Pets Allowed filter, or sign up for alerts when a new pet-friendly home is posted.</p>
