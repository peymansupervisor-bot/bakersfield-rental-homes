...
export const NEIGHBORHOODS: Neighborhood[] = [
  {
    ...
    description:
      'Northwest Bakersfield is one of the most sought-after rental areas in Kern County. Known for newer construction, wide streets, and highly rated schools in the Panama-Buena Vista and Rosedale Union districts, this area attracts families and professionals alike. Direct landlord rentals here mean faster approvals and no broker fees.',
    zips: ['93312', '93314'],
    highlights: ['Top-rated schools', 'Newer homes', 'Safe neighborhoods', 'Easy freeway access'],
    idealFor: 'Families with school-age children and professionals',
  },
  {
    ...
    idealFor: 'Budget-conscious renters and small families',
  },
  {
    slug: 'rosedale',
    name: 'Rosedale',
  ...
  },
  {
    ...
    description:
      'East Bakersfield offers the most affordable rental prices in the city, making it ideal for first-time renters and those on a budget. Close to downtown, the 58 freeway, and Bakersfield College, it\'s a practical location with strong community character. Many landlords rent directly, skipping the middleman.',
    zips: ['93305', '93307'],
    highlights: ['Lowest rents in Bakersfield', 'Near Bakersfield College', 'Downtown access', 'Strong community'],
    idealFor: 'Students, first-time renters, and budget-focused households',
  },
  {
    ...
    description:
      'Oleander-Sunset sits in the heart of Bakersfield — walkable, central, and full of character. Mid-century homes with character, proximity to dining and parks, and easy access to all parts of the city make this a favorite for renters who want to be close to everything. Direct landlord rentals are common in this established area.',
    zips: ['93301', '93304'],
    highlights: ['Central location', 'Walkable streets', 'Character homes', 'Near dining and parks'],
    idealFor: 'Young professionals and couples who want a central, walkable neighborhood',
  },
]
